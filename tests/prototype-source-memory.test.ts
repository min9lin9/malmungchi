...
describe("prototype source memory polish", () => {
    ...
    try {
      ...
      for (let index = 0; index < 3; index++) {
        const refresh = await app.handle(
          new Request("http://localhost/corpus/sources/author:compact-author/refresh", {
            method: "POST",
          })
        );
      ...
      const compact = await app.handle(
        new Request("http://localhost/corpus/sources/author:compact-author/memory/compact", {
          method: "POST",
        })
      );
      ...
      const status = await app.handle(
        new Request("http://localhost/corpus/sources/author:compact-author/status")
      );
      ...
      const history = await app.handle(
        new Request("http://localhost/corpus/sources/author:compact-author/history")
      );
      ...
      const deleteRes = await app.handle(
        new Request("http://localhost/corpus/sources/author:compact-author", { method: "DELETE" })
      );
      ...
      const unknownCompact = await app.handle(
        new Request("http://localhost/corpus/sources/author:not-real/memory/compact", {
          method: "POST",
        })
      );
  ...
  it("does not overwrite a corrupt compaction sidecar", async () => {
    ...
    try {
      ...
      const compact = await app.handle(
        new Request("http://localhost/corpus/sources/author:sidecar-author/memory/compact", {
          method: "POST",
        })
      );
