---
name: ingestion
description: Normalize local Markdown and JSON source folders into Malmungchi raw/normalized document layout while preserving Korean text and provenance.
---

# Ingestion

Use this skill when a user needs local `.md` or `.json` files normalized for Malmungchi author import or persona generation.
