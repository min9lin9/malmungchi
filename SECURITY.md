...
Malmungchi is intended for local or controlled-server operation over user-provided
documents.
...
- Set `MALMUNGCHI_API_KEY` for non-local HTTP deployments.
- Keep `MALMUNGCHI_CORS_ORIGIN` pinned to known origins outside local development.
